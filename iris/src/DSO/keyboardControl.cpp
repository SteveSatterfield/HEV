...
namespace keyboardControl
{
	...
	{
            fprintf(stderr,"togglePolygonMode\n");
	    // Reset to FILL
	    static osg::PolygonMode::Mode mode = osg::PolygonMode::FILL ;
	    fprintf(stderr,"reset to fill\n");
	    ...
	    {
	      //osg::ref_ptr<osg::PolygonStipple> stipple1Mode=new osg::PolygonStipple(patternHorzEven);
		//mode = stipple2Mode;
       	        //osg::ref_ptr<osg::PolygonStipple> stipple2Mode=new osg::PolygonStipple(patternHorzEven2);
	      //ode = stipple2Mode;
		//fprintf(stderr,"stipple2\n");

		dtkMsg.add(DTKMSG_INFO, "iris::keyboardNavControl: changing polygon mode to fill\n") ;
		mode = osg::PolygonMode::FILL ;
		fprintf(stderr,"back to fill\n");
		...
		stateset->setAttributeAndModes(new osg::PolygonStipple(patternHorzEven2), osg::StateAttribute::ON);
	    }
